...
function App(): React.ReactElement {
  ...
  const handleNavigate = (page: string, symbol: string | null = null): void => {
  ...
  return (
    <div className="flex h-screen bg-[#0B0E11] text-[#EAECEF] font-sans selection:bg-[#FCD535] selection:text-black overflow-hidden">
      ...
      <aside className="w-16 bg-[#161A1E] border-r border-[#2B3139] flex flex-col items-center py-4 z-50">
        {/* Logo */}
        <div
          className="mb-8 text-[#FCD535] p-2 bg-[#2B3139]/30 rounded-lg cursor-pointer"
        ...
        <header className="h-12 bg-[#161A1E] border-b border-[#2B3139] flex items-center justify-between px-6 z-40 shadow-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 bg-[#2B3139]/50 rounded-full border border-[#2B3139]">
              ...
              <span className="text-[10px] font-bold text-[#0ECB81] uppercase tracking-wide">
                Testnet
              </span>
            </div>
          ...
          {currentPage === 'trade' && (
            <div className="h-full flex flex-col">
              ...
              <div className="h-12 border-b border-[#2B3139] flex items-center px-4 bg-[#161A1E] gap-4 shrink-0">
                <button
                  onClick={() => setCurrentPage('dashboard')}
                  className="p-1 hover:bg-[#2B3139] rounded text-[#848E9C] hover:text-white transition"
                >
                  <ChevronLeft className="w-5 h-5" />
                </button>
                <div>
                  <div className="flex items-baseline gap-2">
                    <h2 className="text-lg font-bold text-[#EAECEF] leading-none">
                      {selectedSymbol}
                    </h2>
                    <span className="text-xs text-[#0ECB81] bg-[#0ECB81]/10 px-1 rounded">
                      +2.45%
                    </span>
                  </div>
                  <p className="text-[10px] text-[#848E9C] font-mono leading-none mt-1">
                    Perpetual Contract
                  </p>
                </div>
                ...
                <aside className="w-[320px] bg-[#161A1E] border-l border-[#2B3139] flex flex-col">
                  ...
                  <div className="p-4 flex-1">
                    <div className="flex bg-[#0B0E11] p-1 rounded mb-4">
                      <button className="flex-1 py-1.5 text-xs font-bold bg-[#2B3139] text-white rounded shadow-sm">
                        Open
                      </button>
                      <button className="flex-1 py-1.5 text-xs font-bold text-[#848E9C] hover:text-white">
                        Close
                      </button>
                    </div>
